<template>
  <div class="dispatchCompleted">
    <div class="search-box">
      <div class="top-title">数据等级表管理：将数据按照产品等级进行分类</div>
      <div class="search-left">
        <div class="search-item-wrap">
          <div class="search-item">
            <span class="search-name">等级</span>
            <el-input
              placeholder="请输入等级"
          ...
          <div class="search-item">
            <span class="search-name">描述</span>
            <el-input
              placeholder="请输入描述"
              v-model="state.title"
              clearable
      ...
      <template v-slot:operateItem>
        <div class="modal-wrapper">
          <!-- <div class="modal-content">
            <span class="modal-label-name">等级:</span>
            <el-input placeholder="请输入等级" v-model="state.addName" />
          </div> -->
          <div class="modal-content">
            <span class="modal-label-name">描述:</span>
            <el-input placeholder="请输入描述" v-model="state.addTitle" />
          </div>
        </div>
      </template>
    </PIEModal>
    ...
    >
      <template v-slot:operateItem>
        <div class="modal-wrapper">
          <!-- <div class="modal-content">
            <span class="modal-label-name">等级:</span>
            <el-input placeholder="请输入等级" v-model="state.updateName" />
          </div> -->
          <div class="modal-content">
            <span class="modal-label-name">描述:</span>
            <el-input placeholder="请输入描述" v-model="state.updateTitle" />
          </div>
        </div>
      </template>
    </PIEModal>
