  ...
  <div class="dispatchCompleted">
    <div class="search-box">
      <div class="search-left">
        ...
        <div class="search-item">
          <span class="search-name">台网</span>
          <el-select
            :popper-append-to-body="false"
            v-model="state.netWrokId"
            placeholder="请选择台网"
            clearable
            filterable
            @clear="searchData"
          ...
          >
            <el-option
              v-for="item in state.netWrokIdList"
              :key="item.networkId"
              :label="item.cname"
        ...
        <div class="search-item">
          ...
          >
            <el-option
              v-for="item in state.testOptionList"
              :key="item.id"
              :label="item.name"
              :value="item.id"
            ></el-option>
        ...
        <div class="sendOrders">
          ...
          <div class="main-con">
            ...
            <div class="search-item">
              ...
              <el-radio-group
                v-model="state.testOption"
                @change="testOptionChange"
              >
