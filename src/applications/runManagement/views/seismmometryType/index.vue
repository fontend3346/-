<template>
  <div class="dispatchCompleted">
    <div class="search-box">
      <div class="top-title">
        台站类型管理：台站按照台阵类型进行分类的分类标准
      </div>
      <div class="search-left">
        <div class="search-item">
          <span class="search-name">名称</span>
          <el-input placeholder="请输入名称" v-model="state.orderNum" clearable>
          </el-input>
        </div>
      ...
      <template v-slot:operateItem>
        <div class="modal-wrapper">
          <div class="modal-content">
            ...
            <el-input placeholder="请输入名称" v-model="state.stationName" />
          </div>
          <div class="modal-content">
            <span class="modal-label-name">描述:</span>
            <el-input
              placeholder="请输入描述"
              v-model="state.stationDesc"
              type="textarea"
              :rows="5"
            />
          </div>
      ...
      <template v-slot:operateItem>
        <div class="modal-wrapper">
          <div class="modal-content">
            ...
            <el-input
              placeholder="请输入名称"
              v-model="state.updatestationName"
            />
          </div>
          <div class="modal-content">
            <span class="modal-label-name">描述:</span>
            <el-input
              placeholder="请输入描述"
              v-model="state.updatestationDesc"
              type="textarea"
              :rows="5"
            />
          </div>
